<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from uiparadox.co.uk/public/templates/royalfare/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 05:22:11 GMT -->
<head>
    <meta charset="UTF-8">
...
<body id="body">
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content" class="x-hidden">
            <main>
                <!-- Hero Section Start -->
                <section class="hero-banner-2" id="hero">
                    <!-- Header start -->
                    <header id="ui-header">
...
<!-- Mirrored from uiparadox.co.uk/public/templates/royalfare/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 05:22:20 GMT -->
</html>
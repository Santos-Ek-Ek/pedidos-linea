...
<!-- Mirrored from uiparadox.co.uk/public/templates/royalfare/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 05:22:36 GMT -->
<head>
        <meta charset="UTF-8">
...
@endauth
    ...
    <button type="submit" class="cus-btn dark w-100 mb-32">
        ...
        Iniciar sesión
                                        ...
                                        <div class="text-end">
                                            <p class="fw-500 color-black">No tienes una cuenta? <a href="{{route('registerUser')}}" class="color-primary text-decoration-underline"> Registrate</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<!-- Mirrored from uiparadox.co.uk/public/templates/royalfare/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 05:22:36 GMT -->
<head>
        <meta charset="UTF-8">
...
@endauth
                    ...
                    <div class="page-content">  
                        ...
                        <!-- Signup Star -->
                        <section class="py-160">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xxl-8 col-lg-10 offset-xxl-2 offset-lg-1">
                                        <h5 class="mb-16">Crear Cuenta</h5>
                                        <!-- <p class="mb-32">Unlock Exclusive Benefits by Joining Our Community Today!</p> -->
                                        <form method="POST" action="{{ route('registerUser.submit') }}">
    @csrf
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group mb-32">
                <label>Nombre(s)</label>
                <input type="text" name="name" value="{{ old('name') }}" autocomplete="off" placeholder="" required>
                @error('name')
        ...
        <div class="col-sm-6">
            <div class="form-group mb-32">
                ...
                <input type="text" name="lastname" value="{{ old('lastname') }}" autocomplete="off" placeholder="" required>
                @error('lastname')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="col-sm-6">
            <div class="form-group mb-32">
                <label>Email</label>
                <input type="email" name="email" value="{{ old('email') }}" autocomplete="off" placeholder="email@example.com" required>
                @error('email')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="col-sm-6">
            <div class="form-group mb-32">
                ...
                <input type="password" name="password_confirmation" autocomplete="off" placeholder="********" required>
            </div>
        </div>
    </div>
    <button type="submit" class="cus-btn dark w-100 mb-32">
        <!-- SVG y texto del botón -->
        Registrarse
    </button>
</form>
                                        <div class="text-center">
                                            <p class="fw-500 color-black">Ya tienes una cuenta? <a href="{{route('loginUser')}}" class="color-primary text-decoration-underline"> Inicia sesión</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>

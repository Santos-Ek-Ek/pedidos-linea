...
<html lang="en">
  ...
  <head>
    ...
    <title>La Terraza | Registro</title>
    ...
    <div class="register-box">
      ...
      <div class="card card-outline card-primary">
        <div class="card-header">
          ...
          >
            <h1 class="mb-0"><b>La</b> Terraza</h1>
          </a>
        </div>
        <div class="card-body register-card-body">
          <p class="register-box-msg">Registrar un nuevo administrador</p>
          <form method="POST" action="{{ route('admin.register.submit') }}">
                    @csrf
                    
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            <input id="registerFullName" name="nombre_completo" type="text" 
                                   class="form-control @error('nombre_completo') is-invalid @enderror" 
                                   value="{{ old('nombre_completo') }}" placeholder="" required>
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            <input id="registerPasswordConfirmation" name="password_confirmation" 
                        ...
                        <div class="col-8 d-inline-flex align-items-center">
                            <div class="form-check">
                                <input class="form-check-input @error('terms') is-invalid @enderror" 
                                       type="checkbox" name="terms" id="flexCheckDefault" 
                                       {{ old('terms') ? 'checked' : '' }}>

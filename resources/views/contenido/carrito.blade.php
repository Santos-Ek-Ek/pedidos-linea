...
<!-- Mirrored from uiparadox.co.uk/public/templates/royalfare/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 05:22:26 GMT -->
<head>
        <meta charset="UTF-8">
            ...
            <div class="row">
                <div class="col-lg-8 mb-64 mb-lg-0">
                    ...
                    <div class="d-xl-none d-block mb-32">
                        <div class="row" id="mobile-cart-items">
                            <!-- Versión móvil del carrito -->
                        </div>
                    </div>
                    <a href="productosVenta" class="cus-btn primary">
                ...
                <div class="col-lg-4">
                    <div class="cart-summary">
                        <h6 class="title mb-24">RESUMEN DE ORDEN</h6>
                        <div class="cart-summary-detail mb-24">
                            <div class="d-flex justify-content-between align-items-center mb-24">
                                <p class="lead color-black">SUBTOTAL</p>
                                <p class="lead" id="cart-subtotal">$0.00</p>
                            </div>
                            <!-- <div class="d-flex justify-content-between align-items-center mb-24">
                                <p class="lead color-black">Costo de envío</p>
                                <p class="lead" id="delivery-cost">$5.00</p>
                            </div> -->
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-48">
                            <h5 class="color-primary">TOTAL</h5>
                            <h5 class="color-primary" id="cart-total">$0.00</h5>
                        </div>
...
<aside id="sidebar-cart">
    ...
    <div class="price-total mb-24">
        <h6>Subtotal</h6>
        <h5 class="color-primary" id="cart-subtotalmini">$0.00</h5>
    </div>
...
function updateMiniCartView() {
    ...
    const subtotalElement = document.getElementById('cart-subtotalmini');
...
/* Estilo para notas en versión desktop */
.nota-especial {
    font-size: 13px;
    color: #666;
    margin-top: 5px;
...
/* Estilo para notas en versión móvil */
.nota-especial-mobile {
    font-size: 12px;
    color: #666;
    margin-top: 4px;
...
/* Ajuste para el bloque de producto en desktop */
.product-block {
    display: flex;
    align-items: center;
    gap: 15px;
